...
forvalues ws = `ws_1'/`ws_N' {
	...
	*I wanted to create a label for depar with the local below, but it's hard to add the double quotes
	*local depar = " `depar' " + " `ws_`ws'_dpto' " + `" `=char(34)' "' + "`ws_`ws'_name'" //+ "`ws_`ws'_name'" 
}
