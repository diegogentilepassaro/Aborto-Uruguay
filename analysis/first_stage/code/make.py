...
run_stata(program = 'mortality.do', executable = stata)
run_stata(program = 'vital_records.do', executable = stata)
run_stata(program = 'state_of_birth.do', executable = stata)
run_stata(program = 'aggregate_births.do', executable = stata)
run_stata(program = 'misoprostol.do', executable = stata)
run_stata(program = 'google_trends.do', executable = stata)
